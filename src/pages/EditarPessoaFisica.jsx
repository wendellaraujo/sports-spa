...
export default function PessoaFisica(props) {
  ...
  useEffect(() => {
    async function getPessoas(){
        axios.get(`https://localhost:5001/api/pessoa/obter-por-id/${id}`)
        .then(response => {
  ...
  const atualizar = (values) => {
    ...
    axios.put('https://localhost:5001/api/pessoa/atualizar-pessoa-fisica', pessoa)
  ...
  return(
      <div>
        <h1 className="text-white">Atualizar Pessoa Fisica</h1>
          <Card sizeCard="w-50">
